...
export function SellerRegistrationPage() {
  ...
  const validate = useCallback((): boolean => {
    ...
    if (form.tokopediaUrl.trim() && !looksLikeUrl(form.tokopediaUrl))
      next.tokopediaUrl = 'Tautan tidak valid (contoh: https://tokopedia.com/toko-anda).';
  ...
  const goToGoogleLogin = useCallback(() => {
    const returnTo = encodeURIComponent(window.location.origin + '/registrasi-seller');
    ...
    return (
      <div className="seller-page">
        <div className="seller-shell seller-state seller-result">
          ...
          <p>
            Kios <strong>{form.kioskName || 'kamu'}</strong> sudah terdaftar atas nama{' '}
            <strong>{form.name}</strong>. Kamu bisa mulai memasang listing lewat
            aplikasi PasarMotor. Nanti login dengan email yang sama via Google akan
            otomatis tertaut ke kios ini.
          </p>
    ...
    <div className="seller-page">
      <form className="seller-shell" onSubmit={handleSubmit} noValidate>
        <header className="seller-head">
          ...
          <p>Silakan lengkapi informasi berikut untuk mengatur profil penjual dan detail kios Anda.</p>
        </header>
        ...
        {emailTaken && (
          <div className="seller-alert info" role="alert">
            ...
            <span>
              ...
              <button type="button" className="seller-inline-link" onClick={goToGoogleLogin}>
                masuk dengan Google
              </button>{' '}
        ...
        <section className="seller-section">
          ...
          <div className="seller-grid cols-3">
            <div className="seller-field">
              ...
              />
              {fieldErrors.name && <small className="seller-err">{fieldErrors.name}</small>}
            </div>
            <div className="seller-field">
              ...
              />
              {fieldErrors.email && <small className="seller-err">{fieldErrors.email}</small>}
            </div>
            <div className="seller-field">
              ...
              />
              {fieldErrors.phone && <small className="seller-err">{fieldErrors.phone}</small>}
            </div>
          </div>
        </section>
        ...
        <section className="seller-section">
          ...
          <div className="seller-field">
            ...
            />
            {fieldErrors.olxUrl && <small className="seller-err">{fieldErrors.olxUrl}</small>}
          </div>
        </section>

        <div className="seller-actions">
          <Button type="button" variant="outline" onClick={() => navigate('landing')} disabled={submitting}>
            Batal
          </Button>
